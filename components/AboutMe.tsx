        ...
        <>
            <div className="text-center px-10 py-5 dark:text-white">
                ...
                <p className="text-md py-2 leading-8 text-gray md:text-xl max-w-lg mx-auto">
                    Programming enthusiast with experience in design, testing
                    and implementation. Equipped with a diverse skill-set and
                    experience with development tools and procedures. Take a
                    look at my projects or click the icons to view my GitHub or
                    Linkedin!
                </p>
            </div>
