        ...
        <>
            ...
            <div className="py-10 px-10 dark:bg-gray-900 dark:text-white  ">
                ...
                <div className="text-sm md:text-lg lg:text-xl   flex justify-center  px-3 py-1  text-gray-700 mr-2 mb-2">
                    <ReactMarkdown
                        className="prose dark:text-white dark:prose-a:text-white dark:prose-headings:text-white dark:prose-headings:text-gray-100- dark:prose-code:text-gray-400"
